...
var filas=50; //cantidad de triangulos por fila
var columnas=50; //idem por columnas

export default function dibujarGeometria(superficie){
    
    mallaDeTriangulos=generarSuperficie(superficie,filas,columnas);
